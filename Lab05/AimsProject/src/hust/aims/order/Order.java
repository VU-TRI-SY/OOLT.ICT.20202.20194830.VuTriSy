...
public class Order {
	...
	public static boolean checkNbOrder() {
	...
	public DigitalVideoDisc getALuckyItem() {
		...
		System.out.println("The disc: "+itemsOrdered[i].getTitle()+"-"+itemsOrdered[i].getCategory()+"-"+itemsOrdered[i].getDirectory()+"-"+itemsOrdered[i].getLength()+" is free.");
